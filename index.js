...
const temperature1 = [10, 20, 40, 25, 30, 35];
let temp = 0;
...
const numberz = [15, 25, -35, -251, 60];
const checkpositivenumber = (inputnum) => {
    let count = 0;
...
const fruitnames = ["apple", "Water melon", "Appricote", "PineApple", "Avocado"];
function StartwithA(words) {
...
console.log(zyx);
//with Function
function numbertobesquared(input) {
    const numbz = [];
    for (let i = 0; i < input.length; i++) {
...
function false_value_filter(input) {
...
function check_element(input, ele_num) {
    let numbz;
...
function smallest_number_1(input) {
    let v1 = 0;
    let v2 = input[0];
...
function filterByLength(input, str_len) {
    let output_array = [];
    let tmp_str;
    for (let i = 0; i < input.length; i++) {
...
function countOccurances(input, ele_num) {
    let output_array = [];
    let tmp_str = ele_num;
    let tmp_str2 = 0;
    for (let i = 0; i < input.length; i++) {
...
function formatintostring(input) {
    let format_string = "";
    let tmp_str = ", ";
    let tmp_str2 = " and ";
...
function swapElements(input, First_index, second_index) {
...
function find_char(input, fnd_char) {
    let cnt = 0;
    for (let i = 0; i < input.length; i++) {
...
function sortsmalltolarg(input) {
...
function reverse_array1(input) {
    let BNZ = [];
    for (let i = input.length - 1; i >= 0; i--) {
        console.log(input[i]);
    }
}
const curr_array = [1, 2, 3, 4, 5, 6];
